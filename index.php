  ...
  <style media="screen">
    .feedback1
    {
     ...
     <section id="Grocery" class="Grocery">
         ...
         <div class="contain2">
            <div class="box">
            <a href="ShopNow.php?id=<?php echo 6 ?>"><img src="staples 1.jpg" alt=""></a>
              <h2> Staples</h2>

            </div>
            <div class="box">
                <a href="ShopNow.php?id=<?php echo 3 ?>"><img src="beve 1.jpg" alt=""></a>

              <h2>Beverages</h2>

            </div>
            <div class="box">
              <a href="ShopNow.php?id=<?php echo 7 ?>"><img src="snake 1.jpg" alt=""></a>

              <h2>Snack</h2>

            </div>
            <div class="box">
              <a href="ShopNow.php?id=<?php echo 14 ?>"><img src="hp_fresh-fruits-fnv_Storefront_m_250423_02.jpg" alt=""></a>
